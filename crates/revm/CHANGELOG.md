...
## [9.1.0](https://github.com/sablier-labs/sabvm/compare/revm-v9.0.0...revm-v9.1.0) - 2024-05-24

### Added
- *(revm)* revert EIP-2935 BLOCKHASH opcode changes ([#1450](https://github.com/sablier-labs/sabvm/pull/1450))
- load account should return db error ([#1447](https://github.com/sablier-labs/sabvm/pull/1447))
...
### Other
- cargo update ([#1451](https://github.com/sablier-labs/sabvm/pull/1451))
- cleanup host blockhash fn ([#1430](https://github.com/sablier-labs/sabvm/pull/1430))
...
- *(deps)* bump anyhow from 1.0.82 to 1.0.83 ([#1404](https://github.com/sablier-labs/sabvm/pull/1404))
