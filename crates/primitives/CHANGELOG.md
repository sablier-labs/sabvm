...
## [5.0.0](https://github.com/sablier-labs/sabvm/compare/revm-primitives-v4.0.0...revm-primitives-v5.0.0) - 2024-05-24
...
### Fixed
- *(primitives)* specify the optimism cfg on spec_to_generic ([#1412](https://github.com/sablier-labs/sabvm/pull/1412))
