...
## [8.0.0](https://github.com/sablier-labs/sabvm/compare/revm-precompile-v7.0.0...revm-precompile-v8.0.0) - 2024-05-24

### Fixed
- *(precompile)* ignore infinity points in G1 MSM ([#1432](https://github.com/sablier-labs/sabvm/pull/1432))
- *(precompile)* BLS G2 MSM ([#1428](https://github.com/sablier-labs/sabvm/pull/1428))

### Other
- add docs for BLS scalar input decoding ([#1446](https://github.com/sablier-labs/sabvm/pull/1446))
